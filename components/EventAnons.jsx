  ...
  const events = useMemo(() => [
    {
      id: 1,
      date: "23-25 мая",
      title: "Уникальный тур по звуковым практикам",
      desc: "Мы рады объявить о запуске нашего нового тура, посвященного звуковым практикам, который подарит вам возможность погрузиться в мир гармонии и внутреннего спокойствия",
      about: "Медитации с тибетскими чашами, которые проведет Ольга Устинова и плоскими колоколами (билами) которые проведёт Малиновый-Звон Анастасия Вы почувствуйте, как звуки этих уникальных инструментов наполняют ваше пространство, очищают мысли и помогают достичь глубокой медитации",
      plan: ["Мини обучение по проведению медитаций с тибетскими чашами",
        "Природа и единение",
        "Обязательно угостим вас самыми полезными и вкусными блюдами нашей живой кулинарии",
