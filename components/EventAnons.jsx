  ...
  const events = useMemo(() => [
    ...
    },
    {
    ...
    },
     {
      id: 3,
      date: "9-15 июня",
      title: "«Летний недельный детокс тур»",
      desc: "Присоединяйтесь к нашему недельному детокс-туру условного голодания! Это не просто программа очищения, а настоящее путешествие к здоровью и гармонии",
      about: "Мы приготовили для вас особый сюрприз — каждый день вы будете наслаждаться освежающим клубничным соком! Этот натуральный напиток не только порадует ваши вкусовые рецепторы, но и станет отличным дополнением к вашему детокс-меню, наполняя организм витаминами и антиоксидантами",
      plan: ["Условное голодание на травяном отваре по Марве Оганян",
        "Уникальные занятия по йоге и медитации",
        "Полезные лекции о здоровом питании",
        "Мастер класс по керамике ( сотворим лотосный подсвечник)",
        "Каждый день банные спа- процедуры с профессиональным пар мастером",
        "Физические активности: катание на сапах, каяке, велосипеде, рыбалка, купание в реке и бронзовый загар",
