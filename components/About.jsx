  ...
  return (
    <section id="about">
      ...
      <div className="flex my-10 gap-5 items-center">
        ...
        <Image className="rounded" src="/images/detocs.jpg" width={700} height={465.72} alt="Изображение с медитацией" />
      </div>
      <div className="flex my-10 gap-5 items-center">
        <Image className="rounded" src="/images/detocs2.jpg" width={700} height={465.72} alt="Изображение с едой" />
        <div>
          <h2>Живое питание</h2>
